...
class HttpClient:
    ...
    async def get(self, path: str, params: Optional[Dict[str, Any]] = None, 
                 headers: Optional[Dict[str, str]] = None, source_id: str = "default") -> Dict[str, Any]:
        """Make a GET request."""
        return await self.request("GET", path, params=params, headers=headers, source_id=source_id)
    
    async def post(self, path: str, data: Dict[str, Any], params: Optional[Dict[str, Any]] = None, 
                  headers: Optional[Dict[str, str]] = None, source_id: str = "default") -> Dict[str, Any]:
        """Make a POST request."""
        return await self.request("POST", path, params=params, data=data, headers=headers, source_id=source_id)
    
    async def put(self, path: str, data: Dict[str, Any], params: Optional[Dict[str, Any]] = None, 
                 headers: Optional[Dict[str, str]] = None, source_id: str = "default") -> Dict[str, Any]:
        """Make a PUT request."""
        return await self.request("PUT", path, params=params, data=data, headers=headers, source_id=source_id)
    
    async def delete(self, path: str, params: Optional[Dict[str, Any]] = None, 
                    headers: Optional[Dict[str, str]] = None, source_id: str = "default") -> Dict[str, Any]:
        """Make a DELETE request."""
        return await self.request("DELETE", path, params=params, headers=headers, source_id=source_id)
